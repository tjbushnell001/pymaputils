...
def create_lane_group_ref(tile_id, lane_group_id):
    ...
    return geojson_utils.hashify({'type': 'lane_group_ref', 'tile_id': tile_id, 'id': lane_group_id})
...
def create_connector_ref(tile_id, connector_id):
    ...
    return geojson_utils.hashify({'type': 'connector_ref', 'tile_id': tile_id, 'id': connector_id})
...
def create_road_segment_ref(tile_id, road_segment_id):
    ...
    return geojson_utils.hashify({'type': 'road_segment_ref', 'tile_id': tile_id, 'id': road_segment_id})
...
def create_road_connector_ref(tile_id, road_connector_id):
    ...
    return geojson_utils.hashify({'type': 'road_connector_ref', 'tile_id': tile_id, 'id': road_connector_id})
