...
def parse_args(args=None):
    parser = argparse.ArgumentParser(description="Example lane map data parsing script to find a "
                                                 "lane group that intersects a gps point.")
    parser.add_argument('--map_dir', type=str, default="~/tiled_maps",
                        help="The location of the tiled_maps directory. Defaults to embite storage "
                             "location.")
    parser.add_argument('--gps_lat', type=float, default=34.02034454,
                        help="gps latitude point to search for intersection.")
    parser.add_argument('--gps_lon', type=float, default=-117.101569874,
                        help="gps longitude point to search for intersection.")
