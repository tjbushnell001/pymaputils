...
from maps.geojson_tiled_map import GeoJsonTiledMap
...
def build_road_tile(road_graph, road_tile_id, sub_tiles):
    ...
    for lg_id, lg in all_lane_groups.iteritems():
        ...
        road_segment_ref = retile_ref(road_graph, path_refs[0])
        ...
        road_segment = geojson_utils.create_feature(
            ...
            start_connector_ref=retile_ref(road_graph, start_connector_ref),
            end_connector_ref=retile_ref(road_graph, end_connector_ref),
    ...
    for connector_ref, connector in all_connectors.iteritems():
        ...
        road_connector_ref = retile_ref(road_graph, connector.ref)
